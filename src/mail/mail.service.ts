...
<body style="Margin:0;padding:0;min-width:100%;background-color:#dde0e1;">
  ...
  <center style="width: 100%;table-layout:fixed;background-color: white;padding-top: 40px;padding-bottom: 40px;">
        ...
        >
            <tr>
              <td>
                <table align="center" border="0" cellspacing="0" cellpadding="0" role="presentation">
                  <tr>
                    <td style="padding: 0 20px 0 20px;color:green;font-size: 22px;">
                      Hugs for Bugs
                    </td>
                    ...
                    <td style="padding: 0 20px 0 20px;font-size: 22px;color: rgb(185, 25, 185);">
